...
public class ContactDetailActivity extends BaseActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        statusView = findViewById(R.id.activity_detail_update);
        ...
        ((Button)findViewById(R.id.activity_detail_update)).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        ((Button)findViewById(R.id.activity_detail_delete)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                delete();
            }
    ...
    private void goToContacts() {
        Intent intent = new Intent(this,ContactsContract.class);
    ...
    private void populateView(Cursor c) {
        ...
        setStatusBackground(c.getInt(c.getColumnIndex(ContactsContract.Columns.STATUS)),statusView);
        String s;
    ...
    private void addString(TextView view,String oldVal,ContentValues vals,String col) {
