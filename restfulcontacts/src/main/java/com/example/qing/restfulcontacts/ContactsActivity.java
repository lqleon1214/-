...
public class ContactsActivity extends BaseActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    private static  class StatusBinder implements SimpleCursorAdapter.ViewBinder {
        public  StatusBinder(){}
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((Button)findViewById(R.id.activity_contacts_add)).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        listAdapter = new SimpleCursorAdapter(this,R.layout.contact_row,null,FROM,TO,0);
        listAdapter.setViewBinder(new StatusBinder());

        ListView listView = (ListView) findViewById(R.id.activity_contacts_list);
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        return new CursorLoader(this,ContactsContract.URI,PROJ,null,null,ContactsContract.Columns.FNAME + " ASC");
    }
    ...
    void showDetails(int pos) {
        ...
        showDetails(ContactsContract.URI.buildUpon().appendPath(c.getString(c.getColumnIndex(ContactsContract.Columns.ID))).build());
    }
